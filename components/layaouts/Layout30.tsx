...
export const Layout30: FC<Props> = ({ children, title, color }) => {
  return (
      <>
        <Head>
...
{                  "@context": "https://schema.org/", 
                  ...
                  "description": "Kit de redes sociales con mas de 30 diseños para tu marca. Disponibles en la plataforma de Canva, listos para usar.",
                  "brand": {
                    "@type": "Brand",
          ...
          <meta name={ title } content="¡30 días de contenido de redes sociales hecho por ti!, Comparte tu contenido único y atractivo todos los días." />

          <title>Social Media Templates</title>
          <meta name="description" content="¡30 días de contenido de redes sociales hecho por ti!, Comparte tu contenido único y atractivo todos los días." />
          ...
          <meta property="og:description"        content="¡30 días de contenido para redes sociales hecho por ti!, Comparte tu contenido único y atractivo todos los días." />
          ...
          <meta property="og:description" content="Kit de redes sociales con mas de 30 diseños para tu marca. Disponibles en la plataforma de Canva, listos para usar."/>
